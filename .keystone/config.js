...
var import_core94 = require("@keystone-6/core");
...
var Currency = (0, import_core11.list)({
  ...
  fields: {
    ...
    streamPurchases: (0, import_fields14.relationship)({
  ...
  hooks: {
    resolveInput({ operation, resolvedData }) {
      if (operation === "create" && !resolvedData.accountNumber) {
        const timestamp32 = Date.now();
        resolvedData.accountNumber = `ACC-${(/* @__PURE__ */ new Date()).getFullYear()}-${String(timestamp32).slice(-6)}`;
      }
      return resolvedData;
    }
  }
  ...
  hooks: {
    resolveInput({ operation, resolvedData }) {
      if (operation === "create" && !resolvedData.invoiceNumber) {
        const timestamp32 = Date.now();
        resolvedData.invoiceNumber = `INV-${(/* @__PURE__ */ new Date()).getFullYear()}-${String(timestamp32).slice(-6)}`;
      }
      return resolvedData;
    }
  }
...
var LiveSession = (0, import_core33.list)({
  ...
  fields: {
    sessionId: (0, import_fields36.text)({
      validation: { isRequired: true },
      isIndexed: "unique"
    }),
    ...
    merchant: (0, import_fields36.relationship)({
    ...
    agoraChannelName: (0, import_fields36.text)({
      validation: { isRequired: true }
    }),
    agoraChannelId: (0, import_fields36.text)(),
    scheduledStartTime: (0, import_fields36.timestamp)({
      validation: { isRequired: true }
    }),
    actualStartTime: (0, import_fields36.timestamp)(),
    endTime: (0, import_fields36.timestamp)(),
    viewerCount: (0, import_fields36.integer)({
      defaultValue: 0
    }),
    peakViewerCount: (0, import_fields36.integer)({
      defaultValue: 0
    }),
    totalViews: (0, import_fields36.integer)({
      defaultValue: 0
    }),
    totalPurchases: (0, import_fields36.integer)({
      defaultValue: 0
    }),
    totalRevenue: (0, import_fields36.integer)({
      defaultValue: 0
    }),
    region: (0, import_fields36.relationship)({
      ref: "Region.liveSessions",
      many: false,
      validation: { isRequired: true }
    }),
    thumbnailUrl: (0, import_fields36.text)(),
    streamProducts: (0, import_fields36.relationship)({
      ref: "StreamProduct.liveSession",
      many: true
    }),
    streamPurchases: (0, import_fields36.relationship)({
      ref: "StreamPurchase.liveSession",
      many: true
    }),
    broadcastMetadata: (0, import_fields36.json)({
      defaultValue: {}
    }),
    isActive: (0, import_fields36.checkbox)({
      defaultValue: false
    }),
    ...trackingFields
  },
  hooks: {
    resolveInput({ operation, resolvedData }) {
      if (operation === "create" && !resolvedData.sessionId) {
        const timestamp32 = Date.now();
        resolvedData.sessionId = `live_${(/* @__PURE__ */ new Date()).getFullYear()}_${String(timestamp32).slice(-8)}`;
      }
      return resolvedData;
    }
  }
...
var Order = (0, import_core42.list)({
  ...
  fields: {
    ...
    streamPurchases: (0, import_fields45.relationship)({
...
var Product = (0, import_core56.list)({
  ...
  fields: {
    ...
    streamProducts: (0, import_fields56.relationship)({
...
var ProductVariant = (0, import_core64.list)({
  ...
  fields: {
    ...
    streamProducts: (0, import_fields64.relationship)({
...
var Region = (0, import_core66.list)({
  ...
  fields: {
    ...
    liveSessions: (0, import_fields66.relationship)({
...
var StockMovement = (0, import_core81.list)({
  ...
  fields: {
    ...
    createdAt: (0, import_fields81.timestamp)({
      defaultValue: { kind: "now" }
    }),
    ...trackingFields
  },
...
var StreamProduct = (0, import_core84.list)({
  ...
  fields: {
    liveSession: (0, import_fields83.relationship)({
      ref: "LiveSession.streamProducts",
      many: false
    }),
    product: (0, import_fields83.relationship)({
      ref: "Product.streamProducts",
      many: false,
      validation: { isRequired: true }
    }),
    variant: (0, import_fields83.relationship)({
      ref: "ProductVariant.streamProducts",
      many: false
    }),
    featuredAt: (0, import_fields83.timestamp)({
      validation: { isRequired: true }
    }),
    removedAt: (0, import_fields83.timestamp)(),
    sequenceOrder: (0, import_fields83.integer)({
      validation: { isRequired: true }
    }),
    streamPrice: (0, import_fields83.integer)(),
    discount: (0, import_fields83.integer)({
      defaultValue: 0
    }),
    impressions: (0, import_fields83.integer)({
      defaultValue: 0
    }),
    clicks: (0, import_fields83.integer)({
      defaultValue: 0
    }),
    purchases: (0, import_fields83.integer)({
      defaultValue: 0
    }),
    conversionRate: (0, import_fields83.text)(),
    quantity: (0, import_fields83.integer)({
      validation: { isRequired: true },
      defaultValue: 999
    }),
    quantitySold: (0, import_fields83.integer)({
      defaultValue: 0
    }),
    isAvailable: (0, import_fields83.checkbox)({
      defaultValue: true
    }),
    description: (0, import_fields83.text)({
      ui: { displayMode: "textarea" }
    }),
    metadata: (0, import_fields83.json)({
      defaultValue: {}
    }),
    streamPurchases: (0, import_fields83.relationship)({
...
var StreamPurchase = (0, import_core85.list)({
  ...
  fields: {
    liveSession: (0, import_fields84.relationship)({
      ref: "LiveSession.streamPurchases",
      many: false,
      validation: { isRequired: true }
    }),
    streamProduct: (0, import_fields84.relationship)({
      ref: "StreamProduct.streamPurchases",
      many: false,
      validation: { isRequired: true }
    }),
    customer: (0, import_fields84.relationship)({
      ref: "User.streamPurchases",
      many: false
    }),
    customerEmail: (0, import_fields84.text)(),
    quantity: (0, import_fields84.integer)({
      validation: { isRequired: true },
      defaultValue: 1
    }),
    unitPrice: (0, import_fields84.integer)({
      validation: { isRequired: true }
    }),
    totalAmount: (0, import_fields84.integer)({
      validation: { isRequired: true }
    }),
    currency: (0, import_fields84.relationship)({
      ref: "Currency.streamPurchases",
      many: false,
      validation: { isRequired: true }
    }),
    paymentStatus: (0, import_fields84.select)({
      options: [
        { label: "Pending", value: "pending" },
        { label: "Processing", value: "processing" },
        { label: "Completed", value: "completed" },
    ...
    stripePaymentIntentId: (0, import_fields84.text)(),
    order: (0, import_fields84.relationship)({
      ref: "Order.streamPurchases",
      many: false
    }),
    purchasedAt: (0, import_fields84.timestamp)({
      validation: { isRequired: true }
    }),
    completedAt: (0, import_fields84.timestamp)(),
    metadata: (0, import_fields84.json)({
      defaultValue: {}
    }),
    notificationSent: (0, import_fields84.text)({
      defaultValue: "pending"
    }),
    ...trackingFields
  },
  hooks: {
    resolveInput({ operation, resolvedData }) {
      if (operation === "create" && !resolvedData.purchasedAt) {
        resolvedData.purchasedAt = (/* @__PURE__ */ new Date()).toISOString();
      }
      return resolvedData;
    }
  }
...
var Swap = (0, import_core86.list)({
  ...
  fields: {
    fulfillmentStatus: (0, import_fields85.select)({
      type: "enum",
      options: [
        {
          label: "Not Fulfilled",
    ...
    paymentStatus: (0, import_fields85.select)({
      type: "enum",
      options: [
        {
          label: "Not Paid",
    ...
    differenceDue: (0, import_fields85.integer)(),
    confirmedAt: (0, import_fields85.timestamp)(),
    metadata: (0, import_fields85.json)(),
    idempotencyKey: (0, import_fields85.text)(),
    noNotification: (0, import_fields85.checkbox)(),
    canceledAt: (0, import_fields85.timestamp)(),
    allowBackorder: (0, import_fields85.checkbox)(),
    cart: (0, import_fields85.relationship)({
      ref: "Cart.swap"
    }),
    order: (0, import_fields85.relationship)({
      ref: "Order.swaps"
    }),
    address: (0, import_fields85.relationship)({
      ref: "Address.swaps"
    }),
    lineItems: (0, import_fields85.relationship)({
      ref: "LineItem.swap",
      many: true
    }),
    fulfillments: (0, import_fields85.relationship)({
      ref: "Fulfillment.swap",
      many: true
    }),
    payment: (0, import_fields85.relationship)({
      ref: "Payment.swap"
    }),
    return: (0, import_fields85.relationship)({
      ref: "Return.swap"
    }),
    shippingMethods: (0, import_fields85.relationship)({
...
var TaxProvider = (0, import_core87.list)({
  access: {
    operation: {
      query: ({ session }) => permissions.canReadUsers({ session }) || permissions.canManageUsers({ session }),
  ...
  fields: {
    isInstalled: (0, import_fields86.checkbox)({
      defaultValue: true
    }),
    regions: (0, import_fields86.relationship)({
...
var TaxRate = (0, import_core88.list)({
  access: {
    operation: {
      query: ({ session }) => permissions.canReadUsers({ session }) || permissions.canManageUsers({ session }),
      create: permissions.canManageUsers,
  ...
  fields: {
    rate: (0, import_fields87.float)(),
    code: (0, import_fields87.text)(),
    name: (0, import_fields87.text)({
      validation: {
        isRequired: true
      }
    }),
    metadata: (0, import_fields87.json)(),
    products: (0, import_fields87.relationship)({
      ref: "Product.taxRates",
      many: true
    }),
    productTypes: (0, import_fields87.relationship)({
      ref: "ProductType.taxRates",
      many: true
    }),
    region: (0, import_fields87.relationship)({
      ref: "Region.taxRates"
    }),
    shippingOptions: (0, import_fields87.relationship)({
...
var Team = (0, import_core89.list)({
  ...
  fields: {
    name: (0, import_fields88.text)({
      validation: { isRequired: true }
    }),
    description: (0, import_fields88.text)(),
    members: (0, import_fields88.relationship)({
      ref: "User.team",
      many: true
    }),
    leader: (0, import_fields88.relationship)({
      ref: "User.teamLead",
      many: false
    }),
    ...trackingFields
...
var User = (0, import_core90.list)({
  ...
  fields: {
    name: (0, import_fields89.text)({
      validation: { isRequired: true }
    }),
    email: (0, import_fields89.text)({ isIndexed: "unique", validation: { isRequired: true } }),
    password: (0, import_fields89.password)({
      validation: {
    ...
    role: (0, import_fields89.relationship)({
      ref: "Role.assignedTo",
      access: {
        create: permissions.canManageUsers,
        update: permissions.canManageUsers
    ...
    apiKeys: (0, import_fields89.relationship)({ ref: "ApiKey.user", many: true }),
    phone: (0, import_fields89.text)(),
    hasAccount: (0, import_fields89.checkbox)(),
    addresses: (0, import_fields89.relationship)({
      ref: "Address.user",
      many: true
    }),
    orders: (0, import_fields89.relationship)({
      ref: "Order.user",
      many: true
    }),
    orderEvents: (0, import_fields89.relationship)({
      ref: "OrderEvent.user",
      many: true
    }),
    carts: (0, import_fields89.relationship)({
      ref: "Cart.user",
      many: true
    }),
    customerGroups: (0, import_fields89.relationship)({
      ref: "CustomerGroup.users",
      many: true
    }),
    notifications: (0, import_fields89.relationship)({
      ref: "Notification.user",
      many: true
    }),
    payments: (0, import_fields89.relationship)({
      ref: "Payment.user",
      many: true
    }),
    batchJobs: (0, import_fields89.relationship)({
      ref: "BatchJob.createdBy",
      many: true
    }),
    team: (0, import_fields89.relationship)({
      ref: "Team.members",
      many: false
    }),
    teamLead: (0, import_fields89.relationship)({
      ref: "Team.leader",
      many: true
    }),
    userField: (0, import_fields89.relationship)({
      ref: "UserField.user",
      many: false
    }),
    onboardingStatus: (0, import_fields89.select)({
      options: [
    ...
    accounts: (0, import_fields89.relationship)({
      ref: "Account.user",
      many: true
    }),
    invoices: (0, import_fields89.relationship)({
      ref: "Invoice.user",
      many: true
    }),
    businessAccountRequest: (0, import_fields89.relationship)({
      ref: "BusinessAccountRequest.user",
      many: false
    }),
    liveSessions: (0, import_fields89.relationship)({
      ref: "LiveSession.merchant",
      many: true
    }),
    streamPurchases: (0, import_fields89.relationship)({
      ref: "StreamPurchase.customer",
      many: true
    }),
    customerToken: (0, import_fields89.text)({
      ui: {
        createView: { fieldMode: "hidden" },
        itemView: { fieldMode: "read" }
      },
    ...
    tokenGeneratedAt: (0, import_fields89.timestamp)(),
    orderWebhookUrl: (0, import_fields89.text)({
      ui: {
        description: "Webhook URL to call when orders are created/updated (for Openship integration)"
      }
    }),
    ...(0, import_core90.group)({
      label: "Virtual Fields",
      description: "Calculated fields for user display and cart status",
      fields: {
        firstName: (0, import_fields89.virtual)({
          field: import_core90.graphql.field({
            type: import_core90.graphql.String,
            resolve(item) {
              if (!item.name) return "";
        ...
        lastName: (0, import_fields89.virtual)({
          field: import_core90.graphql.field({
            type: import_core90.graphql.String,
            resolve(item) {
              if (!item.name) return "";
        ...
        activeCartId: (0, import_fields89.virtual)({
          field: import_core90.graphql.field({
            type: import_core90.graphql.String,
            async resolve(item, args, context) {
              const sudoContext = context.sudo();
        ...
        billingAddress: (0, import_fields89.virtual)({
          field: (lists) => import_core90.graphql.field({
...
var import_fields90 = require("@keystone-6/core/fields");
var UserField = (0, import_core91.list)({
  access: {
    operation: {
      query: ({ session }) => permissions.canReadUsers({ session }) || permissions.canManageUsers({ session }),
      create: permissions.canManageUsers,
  ...
  fields: {
    user: (0, import_fields90.relationship)({
      ref: "User.userField",
      many: false
    }),
    lastLoginIp: (0, import_fields90.text)(),
    lastLoginUserAgent: (0, import_fields90.text)(),
    loginHistory: (0, import_fields90.json)({
      defaultValue: []
    }),
    preferences: (0, import_fields90.json)({
      defaultValue: {
        theme: "light",
        notifications: true,
    ...
    notes: (0, import_fields90.text)(),
    lastPasswordChange: (0, import_fields90.timestamp)(),
    failedLoginAttempts: (0, import_fields90.json)({
      defaultValue: {
        count: 0,
        lastAttempt: null,
        lockedUntil: null
...
var import_core92 = require("@keystone-6/core");
var import_fields91 = require("@keystone-6/core/fields");
var import_crypto = __toESM(require("crypto"));
var WebhookEndpoint = (0, import_core92.list)({
  access: {
    operation: {
  ...
  fields: {
    ...
    lastTriggered: (0, import_fields91.timestamp)({
      ui: {
        itemView: { fieldMode: "read" },
        description: "Last time this webhook was triggered"
      }
    }),
    failureCount: (0, import_fields91.integer)({
      defaultValue: 0,
      ui: {
        itemView: { fieldMode: "read" },
    ...
    webhookEvents: (0, import_fields91.relationship)({
    ...
    createdAt: (0, import_fields91.timestamp)({
      defaultValue: { kind: "now" },
      ui: { itemView: { fieldMode: "read" } }
    }),
    updatedAt: (0, import_fields91.timestamp)({
      db: { updatedAt: true },
      ui: { itemView: { fieldMode: "read" } }
    })
  }
...
var import_core93 = require("@keystone-6/core");
var import_fields92 = require("@keystone-6/core/fields");
var WebhookEvent = (0, import_core93.list)({
  access: {
    operation: {
      query: permissions.canReadWebhooks,
      create: permissions.canManageWebhooks,
  ...
  fields: {
    ...
    delivered: (0, import_fields92.checkbox)({
      defaultValue: false,
      ui: {
        itemView: { fieldMode: "read" },
